...
> 164 |    await expect(adManagementPage.createdAdstatus(adName)).toHaveText(admanagementdatafixture[6].assert1);
      |                                                           ^ Error: toHaveText can be only used with Locator object, was called with Promise Promise {
  165 |   } else {
  ...
  170 |    await expect(adManagementPage.createdAdstatus(adName)).toHaveText(admanagementdatafixture[6].assert2);
  171 |   }
  172 | 
  173 |   });
  174 | 
