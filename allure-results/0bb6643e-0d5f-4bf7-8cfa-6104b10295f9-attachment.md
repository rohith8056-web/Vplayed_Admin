...
Call log:
  - waiting for locator('//a[normalize-space()=\'Ad Management\']')
    2 × waiting for" https://admin-staginggs.vplayed.com/" navigation to finish...
...
```yaml
- generic [ref=e6]:
  - heading "Log in to your Account" [level=1] [ref=e7]
  - paragraph [ref=e8]: Nice to see you! Sign in now & lets get started.
  - generic [ref=e9]:
    - generic [ref=e11]:
      - textbox "Email ID" [active] [ref=e12]
