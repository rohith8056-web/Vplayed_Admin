...
Locator: locator('//h4[contains(text(), \'Support Platform\')]/following::span[@class=\'mat-select-placeholder mat-select-min-line ng-tns-c21-64 ng-star-inserted\']')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('//h4[contains(text(), \'Support Platform\')]/following::span[@class=\'mat-select-placeholder mat-select-min-line ng-tns-c21-64 ng-star-inserted\']')
