...
- Name: admanagement/admanagement.spec.js >> Functional Testing >> TC-29: when the user enter the adname and click on save the error should show in remaining 3 feilds
- Location: tests/admanagement/admanagement.spec.js:73:3
