...
```
TypeError: adManagementPage.createdAdstatus(...).innerText is not a function
```
            ...
            - tabpanel "External Ad's" [ref=e240]:
              - region "scrollable content" [ref=e248]:
                - table [ref=e250]:
                  ...
                  - rowgroup [ref=e283]:
                    - row "1 Test1786682767427 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 14, 2026" [ref=e284]:
                      - cell "1" [ref=e285]
                      - cell "Test1786682767427" [ref=e286]:
                        - heading "Test1786682767427" [level=5] [ref=e289]:
                          - generic [ref=e290]: Test1786682767427
                      - cell "Web" [ref=e291]
                    ...
                    - row "2 Test1786682025220 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 14, 2026" [ref=e316]:
                      - cell "2" [ref=e317]
                      - cell "Test1786682025220" [ref=e318]:
                        - heading "Test1786682025220" [level=5] [ref=e321]:
                          - generic [ref=e322]: Test1786682025220
                      - cell "Web" [ref=e323]
                      ...
                      - cell "Active On Aug 14, 2026" [ref=e330]:
                        - generic [ref=e331]:
                    ...
                    - row "3 Test1786631481107 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 14, 2026" [ref=e348]:
                      - cell "3" [ref=e349]
                      - cell "Test1786631481107" [ref=e350]:
                        - heading "Test1786631481107" [level=5] [ref=e353]:
                          - generic [ref=e354]: Test1786631481107
                      - cell "Web" [ref=e355]
                    ...
                    - row "4 Test1786630977195 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e380]:
                      - cell "4" [ref=e381]
                      - cell "Test1786630977195" [ref=e382]:
                        - heading "Test1786630977195" [level=5] [ref=e385]:
                          - generic [ref=e386]: Test1786630977195
                      - cell "Web" [ref=e387]
                    ...
                    - row "5 Test1786630794968 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e412]:
                      - cell "5" [ref=e413]
                      - cell "Test1786630794968" [ref=e414]:
                        - heading "Test1786630794968" [level=5] [ref=e417]:
                          - generic [ref=e418]: Test1786630794968
                      - cell "Web" [ref=e419]
                    ...
                    - row "6 Test1786630371313 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e444]:
                      - cell "6" [ref=e445]
                      - cell "Test1786630371313" [ref=e446]:
                        - heading "Test1786630371313" [level=5] [ref=e449]:
                          - generic [ref=e450]: Test1786630371313
                      - cell "Web" [ref=e451]
                    ...
                    - row "7 Test1786629774690 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e476]:
                      - cell "7" [ref=e477]
                      - cell "Test1786629774690" [ref=e478]:
                        - heading "Test1786629774690" [level=5] [ref=e481]:
                          - generic [ref=e482]: Test1786629774690
                      - cell "Web" [ref=e483]
                    ...
                    - row "8 Test1786629676931 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e508]:
                      - cell "8" [ref=e509]
                      - cell "Test1786629676931" [ref=e510]:
                        - heading "Test1786629676931" [level=5] [ref=e513]:
                          - generic [ref=e514]: Test1786629676931
                      - cell "Web" [ref=e515]
                    ...
                    - row "9 Test1786629552613 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e540]:
                      - cell "9" [ref=e541]
                      - cell "Test1786629552613" [ref=e542]:
                        - heading "Test1786629552613" [level=5] [ref=e545]:
                          - generic [ref=e546]: Test1786629552613
                      - cell "Web" [ref=e547]
                    ...
                    - row "10 Test1786629476748 Web https://admin-staginggs.vplayed.com/vplayedqa/super-admin/ad-management?tab=0 Both Portrait Active On Aug 13, 2026" [ref=e572]:
                      - cell "10" [ref=e573]
                      - cell "Test1786629476748" [ref=e574]:
                        - heading "Test1786629476748" [level=5] [ref=e577]:
                          - generic [ref=e578]: Test1786629476748
                      - cell "Web" [ref=e579]
...
```ts
  ...
  154 |    const adName = admanagementdatafixture[5].adname + Date.now();
  155 |    await adManagementPage.adnamefill(adName);
  156 |    await adManagementPage.adurlfill(admanagementdatafixture[5].adurl);
  157 |    await adManagementPage.textlselectionlist(adManagementPage.adsupportplatformplaceholder, "//span[@class='mat-option-text']",adManagementPage.supportplatformlist, admanagementdatafixture[5].supportplatform);
  158 |    await adManagementPage.textlselectionlist(adManagementPage.adorientationplaceholder, "//span[@class='mat-option-text']",adManagementPage.orientationlist, admanagementdatafixture[5].orientation);
  159 |    await adManagementPage.savebtnclick();
  160 |    await page.waitForTimeout(3000);
> 161 |    if (await adManagementPage.createdAdstatus(adName).innerText() === Active) {
      |                                                       ^ TypeError: adManagementPage.createdAdstatus(...).innerText is not a function
  162 |     await adManagementPage.adstatusactivatedeactivate(adName);
  163 |     await page.waitForTimeout(2000);
  164 |     await adManagementPage.adsstatuspopupyesbtn.click();
  165 |     await page.waitForTimeout(2000);
  166 |     await expect(await adManagementPage.createdAdstatus(adName)).toHaveText(Inactive);
  167 |    } else {
  168 |     await adManagementPage.adstatusactivatedeactivate(adName);
  169 |     await page.waitForTimeout(2000);
  170 |     await adManagementPage.adsstatuspopupyesbtn.click();
  171 |     await page.waitForTimeout(2000);
  172 |     await expect(await adManagementPage.createdAdstatus(adName)).toHaveText(Active);
  173 |    }
  174 | 
  175 |   });
  176 | 
