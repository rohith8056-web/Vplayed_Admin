...
Locator:  locator('//span[normalize-space()=\'Test1786683003668\']/following::span[@class=\'upside label-published ng-star-inserted\'][1]')
Expected: "Inactive"
Received: "Active"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('//span[normalize-space()=\'Test1786683003668\']/following::span[@class=\'upside label-published ng-star-inserted\'][1]')
    14 × locator resolved to <span _ngcontent-serverapp-c239="" class="upside label-published ng-star-inserted">Active</span>
...
```ts
  ...
  163 |    await page.waitForTimeout(10000);
> 164 |    await expect(await adManagementPage.createdAdstatus(adName)).toHaveText('Inactive');
      |                                                                 ^ Error: expect(locator).toHaveText(expected) failed
  165 |   } else {
  ...
  170 |    await expect(await adManagementPage.createdAdstatus(adName)).toHaveText('Active');
  171 |   }
  172 | 
  173 |   });
  174 | 
