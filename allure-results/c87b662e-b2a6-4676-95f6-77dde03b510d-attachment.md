...
```
Error: toHaveText can be only used with Locator object, was called with Promise Promise {
  locator('//span[normalize-space()=\'Test1786683003668\']/following::span[@class=\'upside label-published ng-star-inserted\'][1]')
}
```
