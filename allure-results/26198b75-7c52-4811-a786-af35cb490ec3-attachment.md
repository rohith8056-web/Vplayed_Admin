...
Locator:  locator('//h4[contains(text(), \'AD Name\')]/ancestor::div[contains(@class, \'form-group\')]//input[@placeholder=\'Name of the Ad\']')
...
Call log:
  ...
  - waiting for locator('//h4[contains(text(), \'AD Name\')]/ancestor::div[contains(@class, \'form-group\')]//input[@placeholder=\'Name of the Ad\']')
    13 × locator resolved to <input type="text" matinput="" required="" maxlength="100" id="mat-input-2" aria-required="true" formcontrolname="ad_name" _ngcontent-serverapp-c236="" placeholder="Name of the Ad" data-placeholder="Name of the Ad" class="mat-input-element mat-form-field-autofill-control ng-tns-c20-12 ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored"/>
       - unexpected value ""
