              ...
              - generic [ref=e244]:
                ...
                - generic [ref=e248]:
                  - generic [ref=e249]:
                    ...
                    - textbox "Name of the Ad" [ref=e257]: Test1786617194022
                  - generic [ref=e258]:
...
```ts
  ...
  66  |   }
  67  | 
  68  |   async supportplatformfill(placeholderLocator, optionsSelector, visibleText) {
  69  | 
  70  |    await placeholderLocator.click();
> 71  |     await this.page.waitForSelector(optionsSelector, { state: 'visible' });
      |                     ^ Error: page.waitForSelector: selector: expected string, got object
  72  |     const options = this.page.locator(optionsSelector);
  73  |     const total = await options.count();
  74  |     for (let i = 0; i < total; i++) {
  75  |       const el = options.nth(i);
